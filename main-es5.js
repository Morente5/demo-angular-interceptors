...
var routes = [
    {
        path: '',
        loadChildren: function () { return __webpack_require__.e(/*! import() | test-interceptors-test-interceptors-module */ "test-interceptors-test-interceptors-module").then(__webpack_require__.bind(null, /*! ./test-interceptors/test-interceptors.module */ "./src/app/test-interceptors/test-interceptors.module.ts")).then(function (mod) { return mod.TestInterceptorsModule; }); },
    },
];
...
var AlertComponent = /** @class */ (function () {
    ...
    AlertComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.alertService.getAlert$().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (alert) { return _this.alerts = (alert.message ? _this.alerts.concat([alert]) : []); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["delay"])(3000), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (alert) { return _this.removeAlert(alert); })).subscribe();
    };
...
/* harmony import */ var ngx_forkable_http_client__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-forkable-http-client */ "./node_modules/ngx-forkable-http-client/fesm5/ngx-forkable-http-client.js");
...
var CoreModule = /** @class */ (function () {
    function CoreModule(parentModule, translate) {
...
var AlertInterceptor = /** @class */ (function () {
    function AlertInterceptor(alertService) {
        this.alertService = alertService;
    }
    AlertInterceptor.prototype.intercept = function (request, next) {
        var _this = this;
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) {
            if (res instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpResponse"]) {
                _this.alertService.success(res.url + " - " + res.status + " " + res.statusText);
            }
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
            _this.alertService.error(request.url + " - " + error.status + " " + error.statusText);
...
var SwapiSecurityInterceptor = /** @class */ (function () {
    function SwapiSecurityInterceptor(auth) {
        this.auth = auth;
    }
    SwapiSecurityInterceptor.prototype.intercept = function (request, next) {
        request = request.clone({
            setHeaders: {
    ...
    return SwapiSecurityInterceptor;
}());
...
var AlertService = /** @class */ (function () {
    ...
    AlertService.prototype.success = function (message) {
        this.alert({ message: message, type: AlertType.Success });
    };
    AlertService.prototype.error = function (message) {
        this.alert({ message: message, type: AlertType.Error });
    };
    AlertService.prototype.info = function (message) {
        this.alert({ message: message, type: AlertType.Info });
    };
    AlertService.prototype.warn = function (message) {
        this.alert({ message: message, type: AlertType.Warning });
    };
    // main alert method
...
var SwapiService = /** @class */ (function () {
    function SwapiService(http, httpLoader) {
        this.http = http;
        this.httpLoader = httpLoader;
        this.url = 'https://swapi.co/api';
    }
    SwapiService.prototype.getPeople$ = function () {
