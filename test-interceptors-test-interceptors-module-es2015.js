...
let TestInterceptorsRoutingModule = class TestInterceptorsRoutingModule {
};
...
let TestInterceptorsComponent = class TestInterceptorsComponent {
    constructor(swapi, pokeapi) {
        this.swapi = swapi;
...
let TestInterceptorsModule = class TestInterceptorsModule {
};
...
//# sourceMappingURL=test-interceptors-test-interceptors-module-es2015.js.map